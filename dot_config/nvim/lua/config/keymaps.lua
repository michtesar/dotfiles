...
map("n", "e", "<cmd>Neotree toggle reveal<CR>", { desc = "Toggle file explorer" })
map("n", "E", "<cmd>Neotree focus<CR>", { desc = "Focus file explorer" })
map("n", "<leader>n", "<cmd>Neotree toggle reveal<CR>", { desc = "Toggle file explorer" })
